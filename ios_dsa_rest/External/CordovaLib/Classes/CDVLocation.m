...
- (void) startHeadingWithFilter: (CLLocationDegrees) filter
{
    if ([self.locationManager respondsToSelector: @selector(headingOrientation)]) {
        UIInterfaceOrientation currentOrientation = (UIInterfaceOrientation) [[UIDevice currentDevice] orientation];		//landscape orientations are flipped between device and interface, but that won't affect us here
