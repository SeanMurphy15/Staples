...
#define		kNotification_MissingLinksConnectionStarting		@"kNotification_MissingLinksConnectionStarting"		//name of the object being linked
#define		kNotification_MissingLinksConnectionComplete		@"kNotification_MissingLinksConnectionComplete"		//name of the object being linked
