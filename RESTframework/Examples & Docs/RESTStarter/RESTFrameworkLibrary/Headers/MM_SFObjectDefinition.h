...
- (void) parseJSONResponse: (id) json forQuery: (MM_SOQLQueryString *) query withError: (NSError *) error completion: (simpleBlock) completion;
...
- (void) removeLocalRecordsWithSFIDS: (NSSet *) sfIDs;
