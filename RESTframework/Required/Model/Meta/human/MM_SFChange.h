...
+ (void) queueChangeForObject: (MMSF_Object *) object withOriginalValues: (NSDictionary *) original changedValues: (NSDictionary *) changedValues atTime: (NSDate *) date andPush: (BOOL) andPush;
...
+ (BOOL) isChangeSyncingInProgress;// __deprecated_msg("Use isPushingChanges instead.");
