...
@property (nonatomic) BOOL shouldSearchForExistingRecordsWhenImporting;	//defaults to !isFullSyncOperation
@property (nonatomic) BOOL isRetryQuery;								//are we retrying a failed operation?
@property (nonatomic) BOOL isFirstSyncOperation;
@property (nonatomic, strong) NSString *moreURLString;
@property (nonatomic) NSUInteger filteredIDPosition;
@property (nonatomic, readonly) BOOL isContinuationQuery, isEmptyQuery;
@property (nonatomic, strong) MM_SOQLPredicate *predicate;
@property (nonatomic, copy) NSString *aggregateOperation, *aggregateField;
